...
/*public class FoodItemStatistics implements getExpirationDate, Comparable<FoodItem>
{
   static stockreceived()   {
   }
   static expired(int result)   {
    int result = dateReceived()compareTo(getExpirationDate);
    return result;
   }
}*/